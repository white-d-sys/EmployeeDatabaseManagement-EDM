...
* The original package name 'com.employee.EmployeeDatabaseManagement(EDM)' is invalid and this project uses 'com.employee.EmployeeDatabaseManagement.EDM' instead.
